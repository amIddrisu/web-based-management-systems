<?php
require '../controller/aircraftAddController.php';
?>
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">AIRCRAFT ADD</h3>
		</div>
...
<form id="form1" method="post" action="aircraftAdd.php" enctype="multipart/form-data">
