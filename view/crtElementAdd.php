...
$res = new CrtElementValidation();
	...
	if(isset($_POST['submit'])){
		...
		if($res->validate($crtElement)){
				//insert
				$crtElement->addCrtElement($crtElement);
		}
	}
?>
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Add A Critical Element</h3>
		</div>
...
echo '</div>';
 ...
 ?>
    <form id="form1" method="post" action="crtElementAdd.php" enctype="multipart/form-data">
...
<tr>
<th>Speciality</th>
<td><input name="speciality" type="text" placeholder="Speciality" class="form-control input-sm" id="speciality" value="<?php echo $crtElement->speciality; ?>" /></td>
</tr>

<tr>
<th>Description</th>
<td><input name="description" type="text" placeholder="Description" class="form-control input-sm" id="description" value="<?php echo $crtElement->description; ?>" /></td>
</tr>
<tr>
    <td>
</td>
