...
if (isset($_POST['submit'])) {
    $toReference->id = $res->valInput($_POST['id']);
    ...
    if ($res->validate($toReference)) {
        //insert
        $toReference->editToReference($toReference);
    }
}
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Edit A Terms of Reference</h3>
  </div>
...
echo '</div>';
 ...
 ?>
<form  id="form1" method="post" action="toReferenceEdit.php" enctype="multipart/form-data">
...
<td>
    <input type="hidden" name="id" value="<?php echo $toReference->id; ?>" />
