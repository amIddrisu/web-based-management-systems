...
$res = new AuditScheduleValidation();
	...
	if(isset($_POST['submit'])){
		...
		if($res->validate($auditSchedule)){
				//insert
				$auditSchedule->addAuditSchedule($auditSchedule);
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Add An Audit Schedule</h3>
		</div>
...
<form id="form1" method="post" action="auditScheduleAdd.php" enctype="multipart/form-data">
...
<!--<tr>
<th>Helicopter</th>
<td><input name="helicopter" type="checkbox" <?php // if($auditSchedule->helicopter===1 || $auditSchedule->helicopter==1){
