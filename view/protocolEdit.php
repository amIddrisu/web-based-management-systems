<?php
require '../controller/protocolEditController.php';
?>
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Edit A Protocol</h3>
  </div>
...
echo '</div>';
 ...
 ?>
<form  id="form1" method="post" action="protocolEdit.php" enctype="multipart/form-data">
...
<tr>
<th>Scope Number</th>
<td><input name="scp_number" type="text" placeholder="Scope Number" class="form-control input-sm" id="scp_number" value="<?php echo $protocol->scp_number; ?>" /></td>
</tr>
...
<td>
    <input type="hidden" name="id" value="<?php echo $protocol->id; ?>" />
