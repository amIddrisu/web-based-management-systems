<?php
require_once '../controller/scopeAddController.php';
?>
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Add A Scope</h3>
		</div>
...
<form id="form1" method="post" action="scopeAdd.php" enctype="multipart/form-data">
...
<tr>
<th>Scope Number</th>
<td><input name="scp_number" type="text" id="scp_number" placeholder="Scope Number" class="form-control input-sm" value="<?php echo $scope->scp_number; ?>" /></td>
</tr>
<tr>
<th>Description</th>
...
<!--<tr>
<th>Helicopter</th>
<td><input name="helicopter" type="checkbox" <?php // if($scope->helicopter===1 || $scope->helicopter==1){
