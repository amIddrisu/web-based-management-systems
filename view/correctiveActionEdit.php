...
if (isset($_POST['submit'])) {
    $correctiveAction->id = $res->valInput($_POST['id']);
    ...
    if ($res->validate($correctiveAction)) {
        //insert
        $correctiveAction->editCorrectiveAction($correctiveAction);
    }
}
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Edit A Corrective Action</h3>
  </div>
...
echo '</div>';
 ...
 ?>
<form  id="form1" method="post" action="correctiveActionEdit.php" enctype="multipart/form-data">
...
<td>
    <input type="hidden" name="id" value="<?php echo $correctiveAction->id; ?>" />
