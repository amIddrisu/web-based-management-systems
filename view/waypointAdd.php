...
if(isset($_POST['cancel'])){redirect("../view/waypointList.php");}
...
if (isset($_POST['submit'])) {
    ...
    if ($res->validate($waypoint)) {
        //insert
        $res->ERROR_MSG=$res->ERROR_MSG.$waypoint->addWaypoint($waypoint);
    }
}
?>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#waypoint_desc').css('background-color', '#fbf3ba');
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="panel panel-info">
        <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
            <h3 class="panel-title">ADD WAYPOINT</h3>
        </div>
        <div class="panel-body">
            ...
            ?>
            <form id="form1" method="post" action="waypointAdd.php" enctype="multipart/form-data">
                <table class="table-condensed">
                    ...
                    <tr>
                        ...
                        <td><input name="boundary" type="checkbox" <?php if($waypoint->boundary===1 || $waypoint->boundary==1){
                                echo 'checked="checked"';}?> placeholder="Boundary" class="form-control input-sm" id="boundary" value="1" /></td>
                    </tr>
                    <tr>
                        <th>Latitude</th>
                    ...
                    <tr>
                        ...
                        <td><input name="way_type" type="checkbox" <?php if($waypoint->way_type===1 || $waypoint->way_type==1){
                                echo 'checked="checked"';}?> placeholder="Upper/Lower" class="form-control input-sm" id="way_type" value="1" /></td>
                    </tr>
                    <tr>
                        <td>
                        </td>
