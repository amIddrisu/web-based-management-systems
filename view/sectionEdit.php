...
if (isset($_POST['submit'])) {
    $section->id = $res->valInput($_POST['id']);
    $section->name = $res->valInput($_POST['id']);
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="panel panel-info">
        <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
            <h3 class="panel-title">Edit A Section</h3>
        </div>
        <div class="panel-body">
            ...
            ?>
            <form id="form1" method="post" action="sectionEdit.php" enctype="multipart/form-data">
...
<td><select name="dept_id" type="text" placeholder="Department" class="form-control input-sm" id="dept_id">
            ...
            <?php  $section->showDepartmentOptions(); ?>        
                    ...
                    <tr>
                        <td><input type="hidden" name="id" value="<?php echo $section->id; ?>" />
                        </td>
