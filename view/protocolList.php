...
//$stds=$protocolsService->getProtocolss();
?>

<script type="text/javascript">
$(function () {
    $("#list").jqGrid({
        url: "../ajax/protocolListAjax.php",
        datatype: "xml",
        mtype: "GET",
        colNames: ["Scope Number", "Protocol Number", "Department", "Section", "Unit", "Protocol Reference", "Protocol Question"],
        colModel: [
            {name:'scp_number', formatter:'showlink', formatoptions:{baseLinkUrl:'protocolView.php'},width: 80},
            ...
            {name: "pro_reference", width: 80, align: "left" },
            {name: "pro_question", width: 80, align: "left" }
        ],
        pager: "#pager",
        rowNum: 30,
        rowList: [10, 20, 30, 50],
