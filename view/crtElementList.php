...
$stds = $crtElement->getCrtElements();
?>
<script type="text/javascript">
$(function () {
    $("#list").jqGrid({
        url: "../ajax/crtElementListAjax.php",
        datatype: "xml",
        mtype: "GET",
        colNames: ["Critical Area","Speciality","Description"],
        colModel: [
            {name:'crt_area', formatter:'showlink', formatoptions:{baseLinkUrl:'crtElementView.php'},width: 80},
            { name: "speciality", width: 80 },
...
<div class="panel panel-info">
 <div class="panel-heading" style="background-color: #428bca; color:#ffffff">
    <h3 class="panel-title">Critical Elements</h3>
  </div>
