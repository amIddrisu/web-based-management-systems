...
if (isset($_POST['submit'])) {
    $page->page_id = $res->valInput($_POST['id']);
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            ?>
            <form id="form1" method="post" action="pageEdit.php" enctype="multipart/form-data">
                <table class="table-condensed">
                    ...
                    <tr>
                        <td><input type="hidden" name="id" value="<?php echo $page->page_id; ?>" />
                        </td>
